...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The Person is queued at start, but on dequeue the first Person is removed.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: The Person with turns equal zero aren't queued.
    ...
    // Defect(s) Found: The Person with turns less than zero aren't queued.
